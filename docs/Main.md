...
5. [Use a local Launch Page](Use_a_Local_Launch_Page.md)
6. [Add Authorization](Add_Authorization.md)
7. [Prepare for Production](Prepare_for_Production.md)
8. [Add Application Router](Add_Application_Router.md)
9. [Set Up Launchpad](Set_Up_Launchpad.md)
10. [Deploy and Test App in SAP BTP](Deploy_and_Test_App_in_SAP_BTP.md)